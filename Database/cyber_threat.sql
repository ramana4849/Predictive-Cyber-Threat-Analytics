...
--
-- Host: localhost
-- Generation Time: Dec 23, 2021 at 01:02 PM
...
--
-- Database: `cyber_threat`
--
CREATE DATABASE IF NOT EXISTS `cyber_threat` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `cyber_threat`;
...
('1duyniwquu9qwe4himbfm7d992jn8a4r', 'eyJ1c2VyaWQiOjExfQ:1mdsCJ:Ssu5oKTWqAj36kMIKeP1PNy4QRcEkuWkz5eFrY62AhM', '2021-11-05 10:54:51.204359'),
...
('jv72re8d8xvczdx2zhf54mwjfnlj1hjs', 'eyJ1c2VyaWQiOjIzfQ:1n01HV:SPDoz4Ylnf2VOpZMn2d2a0ZKLlCnJfo-Mfb0jFt730g', '2022-01-05 13:03:45.028353'),
...
('q4akim4wlf9bxelq35v6v8dpzn72qpay', 'eyJ1c2VyaWQiOjE5fQ:1mE9hA:hPIKxsCORztmP6-vOzG6uoND8yWNW8sAbNixgjk2V9c', '2021-08-26 12:20:24.419213'),
...
('r0bszgspwsf5148gd96eg4wk72cubj0y', 'eyJ1c2VyaWQiOjIxfQ:1mEAX8:FOQJagBjCgRJSbNfZO7Y_42c2OSC6FmESdc-SF8mKHI', '2021-08-26 13:14:06.555244'),
...
('va7yf8u192wmnx60jzpxntne26vpacr8', 'eyJ1c2VyaWQiOjIyfQ:1n00bD:KTGePRzWQYTXHNsSc9oFqBK4d9O6pK4si82FBR9fdNo', '2022-01-05 12:20:03.611145'),
('vla0wxd5l6o4ntbeikdi3uxu065oxm6d', 'eyJ1c2VyaWQiOjIyfQ:1mdtzu:BE-Pp2a05FgHTLrkdYyndv10WcAJXfVZPT0hsnrHdSY', '2021-11-05 12:50:10.889993'),
...
(21, 'Kapilan', 'Kapilan123@gmail.com', 'Kapilan', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(22, 'Kokulam', 'Kokulam123@gmail.com', 'Kokulam', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(23, 'Gopalan', 'Gopalan123@gmail.com', 'Gopalan', '9535866270', 'India', 'Karnataka', 'Bangalore');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_cyber_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_cyber_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Name_of_Covered_Entity` varchar(30000) NOT NULL,
  `State` varchar(300) NOT NULL,
  `Individuals_Affected` varchar(300) NOT NULL,
  `Date_of_Breach` varchar(300) NOT NULL,
  `Location_of_Breached_Information` varchar(300) NOT NULL,
  `Date_Posted_or_Updated` varchar(300) NOT NULL,
  `breach_start` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_cyber_model`
--

INSERT INTO `remote_user_cyber_model` (`id`, `Name_of_Covered_Entity`, `State`, `Individuals_Affected`, `Date_of_Breach`, `Location_of_Breached_Information`, `Date_Posted_or_Updated`, `breach_start`, `year`, `Source_Ip`, `Destination_Ip`, `Prediction`) VALUES
(1, 'Mid America Kidney Stone Association, LLC', 'MO', '1000', '9/22/2009', 'Network Server', '30-05-2014', '22-09-2009', '2009', '175.45.176.3', '149.171.126.18', 'Theft'),
(2, 'Keith W. Mann, DDS, PLLC', 'NC', '2000', '12-08-2009', 'Desktop Computer, Network Server, Electronic Medical Record', '23-01-2014', '08-12-2009', '2009', '175.45.176.3', '149.171.126.12', 'Hacking'),
(3, 'Children''s Medical Center of Dallas', 'TX', '3800', '11/19/2009', 'Theft Portable Electronic Device, Theft', '23-01-2014', '19-11-2009', '2009', '175.45.176.0', '149.171.126.14', 'Theft'),
(4, 'South Carolina Department of Health and Environmental Control', 'SC', '2850', '2/17/2010', 'Paper', '23-01-2014', '17-02-2010', '2009', '175.45.176.3', '149.171.126.16', 'Improper Disposal'),
(5, 'South Texas Veterans Health Care System', 'TX', '1430', '9/30/2009', 'Paper', '23-01-2014', '30-09-2009', '2009', '175.45.176.3', '149.171.126.18', 'Theft'),
(6, 'Mayo Clinic', 'MN', '1740', '7/15/2009', 'Electronic Medical Record', '23-01-2014', '15-07-2009', '2009', '175.45.176.0', '149.171.126.12', 'Theft'),
(7, 'Puerto Rico Department of Health', 'PR', '115000', '09-03-2010', 'Theft Portable Electronic Device, Theft', '23-01-2014', '03-09-2010', '2010', '175.45.176.1', '149.171.126.13', 'Disclosure'),
(8, 'Texas Health Harris Methodist Hospital Azle', 'TX', '9922', '04-07-2010', 'Theft Portable Electronic Device, Theft', '23-01-2014', '07-04-2010', '2010', '175.45.176.3', '149.171.126.15', 'Loss'),
(9, 'AccentCare Home Health of California, Inc. Medicare # 057564    CA state License # 080000226', 'CA', '1000', '04/20/2012 - 04/21/2012', 'E-mail', '23-01-2014', '20-04-2012', '2012', '175.45.176.1', '149.171.126.16', 'Theft'),
(10, 'UnitedHealth Group health plan single affiliated covered entity', 'MN', '19100', '06/28/2011 - 12/12/2011', 'Theft', '23-01-2014', '01-10-2010', '2010', '175.45.176.2', '149.171.126.13', 'Theft'),
(11, 'Child & Family Psychological Services, Inc.', 'MA', '7250', '10/18/2012-10/29/2012', 'Network Server', '23-01-2014', '18-10-2012', '2012', '175.45.176.0', '149.171.126.18', 'Theft');
...
(13, 'Naive Bayes', '55.28846153846154'),
(14, 'SVM', '53.84615384615385'),
(15, 'Logistic Regression', '58.17307692307693'),
(16, 'Decision Tree Classifier', '53.84615384615385'),
(17, 'SGD Classifier', '50.0'),
(18, 'KNeighborsClassifier', '57.21153846153846'),
(19, 'Random Forest Classifier', '58.17307692307693');
...
(41, 'Theft', '63.63636363636363'),
(42, 'Loss', '9.090909090909092'),
(43, 'Disclosure', '9.090909090909092'),
(44, 'Hacking', '9.090909090909092'),
(45, 'Improper Disposal', '9.090909090909092');
